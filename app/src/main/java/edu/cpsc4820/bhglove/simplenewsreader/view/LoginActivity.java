    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Integer> {
        ...
        protected void onPostExecute(final Integer value) {
            ...
            if (value == 1) {
                ...
                dialog.setTitle(R.string.registration_title);
                dialog.setMessage(R.string.registration_prompt);
                dialog.setPositiveButton("Yes, sign me up", new DialogInterface.OnClickListener() {
                    @Override
                ...
                dialog.setNeutralButton("Nah, next time", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
